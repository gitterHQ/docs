...
Try it from the CLI:
```
$ curl -i -H "Content-Type: application/json" -H "Authorization: Bearer {{token}}" "{{api_url}}/v1/user"
```
...
Try it from the CLI:
```
$ curl -i -H "Content-Type: application/json" -H "Authorization: Bearer {{token}}" "{{api_url}}/v1/user/:userId/orgs"
```
...
Try it from the CLI:
```
$ curl -i -H "Content-Type: application/json" -H "Authorization: Bearer {{token}}" "{{api_url}}/v1/user/:userId/repos"
```
...
Try it from the CLI:
```
$ curl -i -H "Content-Type: application/json" -H "Authorization: Bearer {{token}}" "{{api_url}}/v1/user/:userId/channels"
```
